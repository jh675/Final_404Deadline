window.MemberQuestionModal = (function () {
          var modalEl, titleEl, msgEl, btnCancel, btnConfirm;
          function cacheElements() {
            if (!modalEl) {
              modalEl = document.getElementById("memberQuestionModal");
              if (!modalEl) return false;
              titleEl = document.getElementById("memberQuestionModalTitle");
              msgEl = document.getElementById("memberQuestionModalMessage");
              btnCancel = document.getElementById("memberQuestionModalCancelBtn");
              btnConfirm = document.getElementById("memberQuestionModalConfirmBtn");
            }
            return true;
          }
